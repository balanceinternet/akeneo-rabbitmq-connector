...
namespace Balance\Bundle\RabbitMQBundle\Reader;
        ...
        return [
            ...
            'updatedCondition' => [
                ...
                'options' => [
                    'required' => true,
                    'select2' => true,
                    'label' => 'rabbit_connector.export.product_reader.updatedCondition.label',
                    'help' => 'rabbit_connector.export.product_reader.updatedCondition.help',
                    'choices' => [
                        'doNotApply' => 'rabbit_connector.export.product_reader.updatedCondition.choices.doNotApply',
                        'fromDefinedDate' =>
                            'rabbit_connector.export.product_reader.updatedCondition.choices.fromDefinedDate',
                        'fromLastExecution' =>
                            'rabbit_connector.export.product_reader.updatedCondition.choices.fromLastExecution',
                    ],
                ],
            ],
            'updatedSince' => [
                'options' => [
                    'required' => false,
                    'label' => 'rabbit_connector.export.product_reader.updatedSince.label',
                    'help' => 'rabbit_connector.export.product_reader.updatedSince.help',
                ],
            ],
            'enabledCondition' => [
                'type' => 'choice',
                'options' => [
                    'required' => true,
                    'select2' => true,
                    'help' => 'rabbit_connector.export.product_reader.enabledCondition.help',
                    'label' => 'rabbit_connector.export.product_reader.enabledCondition.label',
                    'choices' => [
                        'onlyEnabled' => 'rabbit_connector.export.product_reader.enabledCondition.choices.onlyEnabled',
                        'onlyDisabled' => 'rabbit_connector.export.product_reader.enabledCondition.choices.onlyDisabled',
                        'doNotApply' => 'rabbit_connector.export.product_reader.enabledCondition.choices.doNotApply',
                    ],
                ],
            ],
            'categorizationCondition' => [
                ...
                'options' => [
                    'required' => true,
                    'select2' => true,
                    'help' => 'rabbit_connector.export.product_reader.categorizationCondition.help',
                    'label' => 'rabbit_connector.export.product_reader.categorizationCondition.label',
                    'choices' => [
                        'onlyCategorized' =>
                            'rabbit_connector.export.product_reader.categorizationCondition.choices.onlyCategorized',
                        'onlyNonCategorized' =>
                            'rabbit_connector.export.product_reader.categorizationCondition.choices.onlyNonCategorized',
                        'doNotApply' =>
                            'rabbit_connector.export.product_reader.categorizationCondition.choices.doNotApply',
                    ],
                ],
            ],
            'completeCondition' => [
                ...
                'options' => [
                    'required' => true,
                    'select2' => true,
                    'help' => 'rabbit_connector.export.product_reader.completeCondition.help',
                    'label' => 'rabbit_connector.export.product_reader.completeCondition.label',
                    'choices' => [
                        'onlyComplete' =>
                            'rabbit_connector.export.product_reader.completeCondition.choices.onlyComplete',
                        'onlyUncomplete' =>
                            'rabbit_connector.export.product_reader.completeCondition.choices.onlyUncomplete',
                        'doNotApply' => 'rabbit_connector.export.product_reader.completeCondition.choices.doNotApply',
                    ],
                ],
            ],
        ];
